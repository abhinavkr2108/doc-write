...
export default function LandingPage() {
  ...
  const navigation = [
    { title: "Home", path: "/" },
    { title: "Create Document", path: "/create" },
    { title: "Edit Document", path: "/edit" },
  ];
        ...
        <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
          <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
            ...
            <h2 className="text-4xl text-gray-800 font-extrabold md:text-5xl">
              Create and Edit Documents with Ease using Doc-Write
            </h2>
            <p>
              Welcome to DocWrite, where your ideas flow seamlessly into shared
              documents, fostering creativity and teamwork. Our platform is
              designed to simplify your document management and collaboration
              process, making it as intuitive and efficient as possible
            </p>
